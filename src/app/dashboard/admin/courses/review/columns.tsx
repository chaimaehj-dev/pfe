...
import {
  AdminCourseType,
  SubmittedCourseType,
} from "@/modules/admin/course/types";
import { formatCourseDuration } from "@/modules/course/utils";
import Image from "next/image";
import Modal from "@/components/shared/modal";
import CourseReview from "@/modules/admin/course/components/forms/course-review";

export const columns: ColumnDef<SubmittedCourseType>[] = [
  {
            ...
            onClick={() => {
              setOpen(
                ...
                <Modal>
                  ...
                  <CourseReview course={{ ...rowData }} />
                  <div></div>
                </Modal>,
                async () => {
                  return {
                    // rowData: await getCategoryByIdAction(rowData?.id),
                  };
                }
              );
            }}
